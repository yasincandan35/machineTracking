...
export default function WastageGraph({ data, isDark = false, style, lineColor = "#ef4444", currentLanguage = 'tr' }) {
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-md font-semibold mb-2">{getTranslation('wastage', currentLanguage)}</h3>
      ...
      {isZoomed && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold mb-4">Wastage - Geniş Görünüm</h3>
