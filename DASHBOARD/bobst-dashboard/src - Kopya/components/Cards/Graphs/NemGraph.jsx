...
export default function NemGraph({ data, isDark = false, style, lineColor = "#10b981", currentLanguage = 'tr' }) {
  const containerRef = useRef(null);
  const [yDomain, setYDomain] = useState([25, 70]);
  ...
  const tooltipProps = {
    formatter: (value) => [`${getTranslation('humidity', currentLanguage)}: ${parseFloat(value).toFixed(2)}%`, getTranslation('value', currentLanguage)],
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-md font-semibold mb-2">{getTranslation('humidity', currentLanguage)}%</h3>
      ...
      {isZoomed && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold mb-4">NEM - Geniş Görünüm</h3>
